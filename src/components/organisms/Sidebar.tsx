          ...
          <div className="mt-4 space-y-4 pt-2">
            {projectData.projects.map((project) => (
              <a 
                ...
                className="block text-base md:text-sm hover:text-colorQuaternary dark:hover:text-colorTertiary transition-all duration-300 ease-in-out relative pl-4 before:content-['•'] before:absolute before:left-0 before:text-colorQuaternary dark:before:text-colorTertiary"
              >
                {project.title}
              </a>
            ))}
