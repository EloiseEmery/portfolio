...
function AskMeSomething() {
    return (
        <div className="py-[100px] sm:py-[200px] lg:flex">
            <div className="sm:pr-[50px] lg:w-[50%] xl:pr-[200px]">
            ...
            <div className="lg:w-[50%]">
                <div className="relative opacity-80 hover:opacity-100 mt-16 lg:mt-0">
                    <div className="absolute -top-6 -right-6 w-full h-[300px] border border-colorQuinary/50 z-0"></div>
