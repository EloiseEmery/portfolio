        ...
        <div className="relative w-full overflow-x-hidden px-4 md:px-10 xl:px-[125px] 2xl:px-[200px]">
          ...
          <div className="sm:flex sm:flex-wrap text-colorWhite w-full lg:w-4/5">
            <div className="sm:w-1/2 lg:w-1/3 mb-10">
              ...
              <ul className="tracking-wider font-figtree space-y-4 text-[15px] font-medium pr-10 sm:max-w-[250px]">
                <li className="cursor-pointer hover:text-colorQuaternary transition-all duration-300 ease-in-out whitespace-nowrap">{linkText3}</li>
            ...
            <div className="sm:w-1/2 lg:w-1/3 mb-10">
              ...
              <ul className="tracking-wider font-figtree space-y-4 text-[15px] font-medium">
                <li className="cursor-pointer hover:text-colorQuaternary transition-all duration-300 ease-in-out"><a href="#ask-me-something">{linkText1}</a></li>
                <li className="cursor-pointer hover:text-colorQuaternary transition-all duration-300 ease-in-out"><a href="#my-skillset">{linkText2}</a></li>
              </ul>
            </div>
            <div className="sm:w-1/2 lg:w-1/3 mb-10">
          ...
          <div className="border-t border-colorWhite/10 py-10">
            <div className="text-colorWhite font-sans text-[11px] md:flex md:justify-between">
              ...
              <p className="flex whitespace-nowrap">{footerText1} <img src={Heart} alt="Heart" className="h-[10px] px-2 mt-1" /> {footerText2}</p>
            </div>
          </div>
        </div>
      );
