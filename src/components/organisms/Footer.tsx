...
function Footer() {
      ...
      return (
        <div className="relative w-full px-4 md:px-10 xl:px-[125px] 2xl:px-[200px] overflow-x-hidden ">
          {/* Decorative element */}
          <div className="absolute -right-[100px] bottom-[150px]">
          ...
          <div className="sm:flex sm:flex-wrap text-colorWhite w-full lg:w-4/5">
            <div className="sm:w-1/2 lg:w-1/3 mb-10">
              ...
              <ul className="font-figtree space-y-4 text-[15px] font-medium pr-10 ">
                ...
                <li className="cursor-pointer hover:text-colorQuaternary transition-all duration-300 ease-in-out">Société Québécoise des Infrastructures</li>
                <li className="cursor-pointer hover:text-colorQuaternary transition-all duration-300 ease-in-out">Tribunal Administratif du Québec</li>
              </ul>
            </div>
            <div className="sm:w-1/2 lg:w-1/3 mb-10">
              ...
              <ul className="font-figtree space-y-4 text-[15px] font-medium">
                ...
                <li className="cursor-pointer hover:text-colorQuaternary transition-all duration-300 ease-in-out">My projects</li>
              </ul>
            </div>
            <div className="sm:w-1/2 lg:w-1/3 mb-10">
              <h3 className="font-sans text-lg font-regular mb-4 opacity-50">Contact me</h3>
              <div className="flex gap-4">
                <a href="https://www.linkedin.com/in/eloise-emery/" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://github.com/eloiseemery" target="_blank" rel="noopener noreferrer">
                  <div className="cursor-pointer border border-colorWhite/30 rounded-full p-2 hover:border-colorWhite/100 transition-all duration-300 ease-in-out ">
                    <img src={iconeGithub} alt="Github" className=" max-w-[22px]" />
                  </div>
                </a>
                <a href="https://www.facebook.com/EloiseHeilwidisEmery/" target="_blank" rel="noopener noreferrer">
                  <div className="cursor-pointer border border-colorWhite/30 rounded-full p-2 hover:border-colorWhite/100 transition-all duration-300 ease-in-out ">
                    <img src={iconeFacebook} alt="Facebook" className="max-w-[22px]" />
                  </div>
                </a>
              </div>
            </div>
          ...
          <div className="border-t border-colorWhite/10 py-10">
            <div className="text-colorWhite font-sans text-[11px] md:flex md:justify-between">
              <p className="mb-2 md:mb-0"> 2025 eloisemery.com. All rights reserved.</p>
