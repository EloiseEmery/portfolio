    ...
    return (
        <div className="relative pb-10 md:pb-0">
            ...
            <div className="relative shadow-md bg-transparent bg-gradient-to-r from-[#bfc4d4] via-[#bfc4d4] to-[#bac2dd] dark:from-[#31465d] dark:via-[#31465d] dark:to-[#31465d] rounded-lg p-10 md:flex z-11">
                <div className="items-center flex md:w-1/2 lg:w-2/5 justify-end md:justify-center md:mr-10">
                    <img src={document.documentElement.classList.contains('dark') ? decorativeForms : decorativeFormLight} className="max-h-[200px] lg:max-h-[200px]" alt="decorative forms" />
                </div>
                <div className="md:w-1/2 lg:w-3/5 py-8">
                    ...
                    <p className="max-w-[450px] text-colorMain dark:text-colorWhite font-figtree text-base mt-6 pb-8">{paragraph}</p>
                    <Button 
                        children={button}
                        aria-label={button}
                        ...
                        blank={true}
                        type="secondary"
                        icon={<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" strokeWidth="3" stroke="currentColor" fill="none" className="w-4 h-4 dark:text-colorWhite text-colorTertiary dark:group-hover:text-colorMain group-hover:text-colorWhite">
